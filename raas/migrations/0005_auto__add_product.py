...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'raas_product', (
            ...
            ('product_group', self.gf('django.db.models.fields.CharField')(default='', max_length=255)),
            ('brand', self.gf('django.db.models.fields.CharField')(default='', max_length=100)),
            ('color', self.gf('django.db.models.fields.CharField')(default='', max_length=100)),
            ('list_price', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('manufacturer', self.gf('django.db.models.fields.CharField')(default='', max_length=100)),
        ))
        db.send_create_signal('raas', ['Product'])


    def backwards(self, orm):
        # Deleting model 'Product'
        db.delete_table(u'raas_product')
