...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'raas_product', 'title', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Product.title'
        db.alter_column(u'raas_product', 'title', self.gf('django.db.models.fields.CharField')(max_length=255))
