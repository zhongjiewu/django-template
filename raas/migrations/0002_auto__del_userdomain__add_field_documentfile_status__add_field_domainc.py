...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DocumentFile.status'
        db.add_column(u'raas_documentfile', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DomainConfig.user'
        db.add_column(u'raas_domainconfig', 'user',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'DocumentFile.status'
        db.delete_column(u'raas_documentfile', 'status')

        # Deleting field 'DomainConfig.user'
        db.delete_column(u'raas_domainconfig', 'user_id')
