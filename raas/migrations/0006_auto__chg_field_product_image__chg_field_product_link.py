...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'raas_product', 'image', self.gf('django.db.models.fields.URLField')(max_length=500))

        # Changing field 'Product.link'
        db.alter_column(u'raas_product', 'link', self.gf('django.db.models.fields.URLField')(max_length=500))

    def backwards(self, orm):

        # Changing field 'Product.image'
        db.alter_column(u'raas_product', 'image', self.gf('django.db.models.fields.URLField')(max_length=200))

        # Changing field 'Product.link'
        db.alter_column(u'raas_product', 'link', self.gf('django.db.models.fields.URLField')(max_length=200))
