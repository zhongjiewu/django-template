...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DomainConfig.filename'
        db.add_column(u'raas_domainconfig', 'filename',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DomainConfig.filename'
        db.delete_column(u'raas_domainconfig', 'filename')
