...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RecResults'
        db.create_table(u'raas_recresults', (
            ...
            ('target', self.gf('django.db.models.fields.IntegerField')(default=-1)),
            ('score', self.gf('django.db.models.fields.FloatField')(default=0)),
        ))
        db.send_create_signal('raas', ['RecResults'])


    def backwards(self, orm):
        # Deleting model 'RecResults'
        db.delete_table(u'raas_recresults')
